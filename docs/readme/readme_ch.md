...
<p align="center">
  ...
  <em>内置 Agent | 零配置 | 任意 API 密钥 | 多 Agent | 本机 WebUI | 跨平台 | 24/7 自动化</em>
</p>
...
<p align="center">
  <strong>💬 社区：</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-17.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/AionUI" target="_blank">Twitter</a>
</p>
...
Forge WebUI 会在运行 Forge 的这台电脑上的浏览器中打开 Forge。

- 它不支持局域网、手机或平板、远程服务器、反向代理或隧道。
...
- [🌐 本机 WebUI 使用指南](../guides/webui.md) — 在此电脑浏览器中使用 WebUI 的指南
