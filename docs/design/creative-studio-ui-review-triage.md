...
| **3.4** | Duration stated in three vocabularies        | Open. `Played 0s · Source 5s`, the ruler, and `Renders 10s` are all ours. Consolidating is a copy-and-layout change, not a behaviour change.                                                        |
