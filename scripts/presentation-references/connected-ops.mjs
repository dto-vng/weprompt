  ...
  slides: [
    ...
    },
    {
      ...
      shapes: [
        ...
        ...coPill(0, 5.6, '85', 'Global use cases'),
        ...coPill(1, 5.6, '20,000+', 'Connected workers'),
        ...coPill(2, 5.6, '3,499', 'Connected machines'),
        ...coPill(0, 11.0, '144', 'Sites on rollout'),
        ...coPill(1, 11.0, '225k', 'Data tags'),
        ...coPill(2, 11.0, '62', '3D printers deployed'),
      ],
      notes:
