...
<p align="center">
  ...
  <em>Вбудований агент | Нульове налаштування | Будь-який API ключ | Мульти-агенти | Локальний WebUI | Кросплатформеність | Автоматизація 24/7</em>
</p>
...
| Локальний доступ через браузер     | Рідко                     | **WebUI**                                                                                                            |
...
## Використання Forge у локальному браузері

Forge WebUI відкриває Forge у браузері на цьому самому комп'ютері, де запущено Forge.

- LAN, телефони чи планшети, віддалені сервери, зворотні проксі та тунелі не підтримуються.
