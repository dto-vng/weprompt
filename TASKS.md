...
- [ ] **[BUG-025][P2][Creative Studio] `StudioPage.dom.test.tsx` batch-action test flakes in full-suite position**
  ...
  - Next step for whoever takes it: instrument which of `requestTransition`'s early-return conditions fires under the reproduction, rather than inferring it. The second flaking test is likely the same defect and a useful second data point.
